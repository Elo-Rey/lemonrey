...
const Menu = () => {
    ...
    return (
        <div className='menu-container'>
            ...
            <ArrowDownCircle color="#F4CE14" size={40} className='scroll-bottom-1' onClick={scrollToBottom}> </ArrowDownCircle> */}
            <ArrowUpCircle color="#F4CE14" size={40} className='scroll-top-1' onClick={scrollToTop}> </ArrowUpCircle>
            ...
            <div className='breakfast-menu'>
                ...
                <h2 className='breakfast-subtitle'> Start your day with our excellent options! </h2>
                <div className='breakfast-jumbotron'>

                </div>
                <div className='breakfast-tiles'>
                    <div className='breakfast-tile-1'>
                    <img src="/lemon-breakfast-1.webp" width={350} height={300} alt="little lemon's Egg Sandwiches with Feta." className="tile1"/>
                    ...
                    <img src="/lemon-breakfast-2.webp" width={350} height={300} alt="little lemon's Spinach and egg scramble with raspberries." className="tile1"/>
                    <h4 className="breakfast-food"> Spinach-Egg scramble(Raspberries) <h4 className="breakfast-price"> $11.99 </h4> </h4>
                    <p className="breakfast-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                    <div className='breakfast-tile-3'>
                    <img src="/lemon-breakfast-3.webp" width={350} height={300} alt="little lemon's Muffin Tin Spanakopita Omeletes." className="tile1"/>
                ...
                <h2 className='lunch-subtitle'> Refuel and Keep Going! </h2>
                <div className='lunch-jumbotron'>

                </div>
                <div className='lunch-tiles'>
                    <div className='lunch-tile-1'>
                    <img src="/lemon-lunch-1.webp" width={350} height={300} alt="little lemon's Grilled Pork Kabobs with Vegetables." className="tile1"/>
                    <h4 className="lunch-food"> Grilled Pork Kabobs <h4 className="lunch-price"> $9.99 </h4> </h4>
                    ...
                    <img src="/lemon-lunch-2.webp" width={350} height={300} alt="little lemon's Puff Pastry with Tuna, Tomatoes and Olives." className="tile1"/>
                    <h4 className="lunch-food"> Puff Pastry: Tuna, Tomatoes, Olives <h4 className="lunch-price"> $10.49 </h4> </h4>
                    <p className="lunch-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                    <div className='lunch-tile-3'>
                    <img src="/lemon-lunch-3.webp" width={350} height={300} alt="little lemon's Sicilian Pasta and Chicken, Cherry Tomatoes and Capers." className="tile1"/>
                    <h4 className="lunch-food"> Sicilian Pasta and Chicken <h4 className="lunch-price"> $15.39 </h4> </h4>
                    <p className="lunch-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                ...
                <h2 className='dinner-subtitle'> Mouth Watering Options, whether alone or with Company! </h2>
                <div className='dinner-jumbotron'>

                </div>
                <div className='dinner-tiles'>
                    <div className='dinner-tile-1'>
                    <img src="/lemon-dinner-1.jpg" width={350} height={300} alt="little lemon's Skillet Greek Sun-Dried Tomato Chicken and Farro." className="tile1"/>
                    <h4 className="dinner-food"> Skillet Greek Dried Tomato-Chicken <h4 className="dinner-price"> $13.99 </h4> </h4>
                    ...
                    <img src="/lemon-dinner-2.jpg" width={350} height={300} alt="little lemon's Sweet Potatoes Noodles and Almond Sauce." className="tile1"/>
                    <h4 className="dinner-food"> Potatoes Noodles in Almond Sauce  <h4 className="dinner-price"> $12.99 </h4> </h4>
                    <p className="dinner-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                    <div className='dinner-tile-3'>
                    <img src="/lemon-dinner-3.jpg" width={350} height={300} alt="little lemon's Lemon Chicken Asaparagus." className="tile1"/>
                ...
                <h2 className='drinks-subtitle'> Cold, Tasty, Excellent! </h2>
                <div className='drinks-jumbotron'>

                </div>
                <div className='drinks-tiles'>
                    <div className='drinks-tile-1'>
                    <img src="/lemon-drinks-1.jpg" width={350} height={300} alt="little lemon's Mocktails." className="tile1"/>
                    ...
                    <img src="/lemon-drinks-2.jpg" width={350} height={300} alt="little lemon's Wines ." className="tile1"/>
                    <h4 className="drinks-food"> Wines  <h4 className="drinks-price"> $9.99 </h4> </h4>
                    <p className="drinks-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                    <div className='drinks-tile-3'>
                    <img src="/lemon-drinks-3.jpg" width={350} height={300} alt="little lemon's Ice-creams." className="tile1"/>
                ...
                <h2 className='desserts-subtitle'> Superb Experience, Don't believe? Try it! </h2>
                <div className='desserts-jumbotron'>

                </div>
                <div className='desserts-tiles'>
                    <div className='desserts-tile-1'>
                    <img src="/lemon-desserts-1.webp" width={350} height={300} alt="little lemon's Tiramisu." className="tile1"/>
                    ...
                    <img src="/lemon-desserts-2.webp" width={350} height={300} alt="little lemon's Greek Baklava ." className="tile1"/>
                    <h4 className="desserts-food"> Greek Baklava  <h4 className="desserts-price"> $9.99 </h4> </h4>
                    <p className="desserts-spec"> This work was prepared by Ikwuezuma Elochukwu Reynolds. you will now see lorem ipsum because i'm not really in the mood to coome up with something to write </p>
                    </div>
                    <div className='desserts-tile-3'>
                    <img src="/lemon-desserts-3.webp" width={350} height={300} alt="little lemon's Tarte Tatin." className="tile1"/>
